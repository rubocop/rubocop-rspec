...
RSpec.describe RuboCop::Cop::RSpec::SpecFilePathFormat, :config do
  ...
  shared_context 'with successful require stubbing' do
    before do
  ...
  shared_context 'with ActiveSupport available' do
    before do
  ...
  shared_context 'when using ActiveSupport integration' do
    around do |example|
    ...
    before do
      ...
      inflector = instance_double('ActiveSupport::Inflector')
  ...
  context 'when ActiveSupport inflections are available' do
    include_context 'when using ActiveSupport integration'
    include_context 'with ActiveSupport available'
  ...
  context 'when configured with custom InflectorPath' do
    ...
    context 'when inflector file exists' do
      include_context 'with successful require stubbing'
