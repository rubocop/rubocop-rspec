...
RSpec.describe RuboCop::Cop::RSpec::EmptyLineAfterSharedInclusion do
  ...
  it 'does not register an offense for conditional inclusion after inclusion' do
    expect_no_offenses(<<~RUBY)
      RSpec.describe User do
        it_behaves_like 'cachable response'
        it_behaves_like 'language-dependent' if condition
  ...
  it 'does not register an offense for inclusion after conditional inclusion' do
    expect_no_offenses(<<~RUBY)
      RSpec.describe User do
        it_behaves_like 'cachable response' if condition
        it_behaves_like 'language-dependent'
  ...
  it 'does not register an offense for conditional inclusion with unless' do
    expect_no_offenses(<<~RUBY)
      RSpec.describe User do
        include_context 'with_authentication'
        include_context 'with_authorization' unless condition
  ...
  it 'registers an offense for conditional inclusion not followed ' \
     'by empty line' do
    expect_offense(<<~RUBY)
      RSpec.describe User do
        include_context 'with_authentication'
        include_context 'with_authorization' if condition
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Add an empty line after shared example inclusion.
        it { does_something }
      end
    RUBY
  ...
  it 'does not register an offense when conditional inclusion ' \
     'is the last child' do
    expect_no_offenses(<<~RUBY)
      RSpec.describe User do
        it { does_something }
        include_context 'with_authentication' if condition
      end
    RUBY
  end

  it 'does not treat block-form if with inclusion as consecutive' do
    expect_offense(<<~RUBY)
      RSpec.describe User do
        include_context 'with_authentication'
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Add an empty line after shared example inclusion.
