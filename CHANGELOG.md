...
- Add new `RSpec/PreferredSharedExampleMethods` cop to allow specifying preferred methods to use for defining and including shared examples and context. ([@dvandersluis])
