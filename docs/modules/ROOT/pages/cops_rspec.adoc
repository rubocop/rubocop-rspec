...
==== `Splitting: describe_top_level_group`
...
==== `Combining: describe_top_level_group`
...
* https://www.rubydoc.info/gems/rubocop-rspec/RuboCop/Cop/RSpec/DescribeTopLevelGroup
